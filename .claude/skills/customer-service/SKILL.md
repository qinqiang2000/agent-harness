...
使用 `kb://` 协议引用知识库文档，格式为相对于 `data/kb/` 的路径：
...
**示例**：
- 读取文件：`data/kb/产品与交付知识/11-常见问题/一问一答/星瀚旗舰版/开票.md`
- 引用写法：`根据 [开票](kb://产品与交付知识/11-常见问题/一问一答/星瀚旗舰版/开票.md) 文档：...`

**要求**：
- **必须**使用 `kb://` 协议，**禁止**直接使用 `https://` 链接
- 路径为 Read 工具读取时使用的路径，去掉 `data/kb/` 前缀
- 确保答案产品线与用户问题匹配
