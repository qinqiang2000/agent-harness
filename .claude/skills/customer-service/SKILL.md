...
|----------|-------------|
| API/接口问题 | `kb/API文档/` |
| 标准版问题 | `kb/产品与交付知识/11-常见问题/标准版发票云问题/` 或 `一问一答/标准版/` |
| 星瀚旗舰版问题 | `kb/产品与交付知识/11-常见问题/星瀚旗舰版/` 或 `一问一答/星瀚旗舰版/` |
| 星空旗舰版问题 | `kb/产品与交付知识/11-常见问题/星空旗舰版/` 或 `一问一答/星空旗舰版/` |
| 乐企问题 | `kb/产品与交付知识/11-常见问题/乐企问题/` |
| 订单/EOP问题 | `kb/产品与交付知识/11-常见问题/发票云订单问题/` |
| 版本发布信息 | `kb/产品与交付知识/01-交付赋能/产品知识/产品发版说明/[产品名]/` |
| 功能手册 | `kb/产品与交付知识/01-交付赋能/产品知识/功能说明手册_操作手册/` |
...
**直接使用上面的"快速定位表"确定搜索起点**，无需再执行 `tree` 或 `ls` 探索目录结构。

1. **按问题类型选择起点**（参考"知识库位置"中的快速定位表）：
   - **API 集成问题** → 直接搜索 `kb/API文档/`
   - **产品问题** → 先搜索 `kb/产品与交付知识/11-常见问题/[产品名]/`
   - **辅助系统问题** → 搜索对应的问题目录（乐企问题/发票云订单问题等）

2. **扩展搜索（仅在需要时）**：如果常见问题目录无结果，再搜索 `kb/产品与交付知识/` 下其他专用目录，获得足够信息后立即停止
