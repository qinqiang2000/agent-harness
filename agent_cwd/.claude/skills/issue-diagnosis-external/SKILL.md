...
- **只能使用 [.claude/skills/issue-diagnosis/references/db-queries.md](.claude/skills/issue-diagnosis/references/db-queries.md) 中的预定义模板**，原样替换占位符后执行
...
**数据源选择规则**（参照 `.claude/skills/issue-diagnosis/db/db_config.json`）：
