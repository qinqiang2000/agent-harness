...
| base-file-center | piaozone/base/base-file-center |
| bill-organization | piaozone/base/bill-organization |
| bill-account-statement | piaozone/output/bill-account-statement |
| bill-portal | piaozone/base/bill-portal |
| bill-portal-h5 | piaozone/base/bill-portal-h5 |
| bill-bm-ocr-invoice | piaozone/input/bill-bm-ocr-invoice |
| bill-input-account-manage-portal | piaozone/input/bill-input-account-manage-portal |
| bill-input-account-wechat-applet-portal | piaozone/input/bill-input-account-wechat-applet-portal |
| base-cosmic-init | piaozone/base/base-cosmic-init |
| bill-operate-report | piaozone/base/bill-operate-report |
| base-order | piaozone/base/base-order |
| base-iam | piaozone/base/base-iam |
| bill-business-cms | piaozone/base/bill-business-cms |
| bill-expense | piaozone/base/bill-expense |
| wechat-mini-program | piaozone/input/bill-wechat-mini-program |
| base-platform-adapter | piaozone/base/base-platform-adapter |
| bill-websocket | piaozone/output/bill-websocket |
| base-ai-portal | piaozone/base/base-ai-portal |
| base-ai-llm | piaozone/base/base-ai-llm |
| base-ai-data-match | piaozone/base/base-ai-data-match |
| base-ai-python | piaozone/base/base-ai-python |
| base-ai-file-cls | piaozone/base/base-ai-file-cls |
| base-monitor-collect | piaozone/base/base-monitor-collect |
| base-llm-config | piaozone/base/base-llm-config |
| base-chat-service | piaozone/base/base-chat-service |
| base-chat-service-web | piaozone/base/base-chat-service-web |
| base-log-alert | piaozone/base/base-log-alert |
| base-online-view | piaozone/base/base-online-view |
| base-gateway | piaozone/base/base-gateway |
| base-auth | piaozone/base/base-auth |
| base-cost | piaozone/base/base-cost |
| base-rights | piaozone/base/base-rights |
| bill-gateway | piaozone/base/bill-gateway |
| base-file-center-server | piaozone/base/base-file-center-server |
