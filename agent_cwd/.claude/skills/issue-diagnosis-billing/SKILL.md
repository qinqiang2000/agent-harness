...
**路径 B — 无可查线索**（无 traceId，也无任何报错/关键字，仅描述业务疑问，且非需求/变更）：
...
输出后立即判断是否为代码/配置问题，满足以下任意条件则触发 code-fix：
- 【定位】中包含 `源码: {ClassName}.java:{行号}`
- 【变更方案】中包含"修改代码"、"修改配置"、"新增配置项"
